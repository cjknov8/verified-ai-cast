...
const nextConfig: NextConfig = {
  async headers() {
    return [
      ...
      {
        source: "/(operations|agency|pricing-model|settlements|brand-assets|brand-assets/:path*|infrastructure|business-plan|login|projects/:path*|reviews/:path*|talents/:path*)",
        headers: [

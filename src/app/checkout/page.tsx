    ...
    <main className="min-h-screen bg-[#111817] text-white">
      <header className="border-b border-white/10">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5 sm:px-8">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold uppercase tracking-[0.16em]">{brand.name}</span>
          </Link>
          <div className="flex items-center gap-3">
            <p className="hidden text-xs uppercase tracking-[0.14em] text-white/45 sm:block">Secure review reservation</p>
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-12 sm:px-8 lg:grid-cols-[1fr_0.72fr] lg:py-20">
        <section>
          ...
          <h1 className="mt-4 max-w-xl font-serif text-5xl leading-tight sm:text-6xl">Reserve an official asset review.</h1>
          ...
          <ol className="mt-10 space-y-5 border-t border-white/12 pt-6 text-sm text-white/72">
            ...
            <li className="flex gap-4"><span className="font-mono text-[#d4b477]">02</span><span>Submit the finished media or placement package.</span></li>
        ...
        <aside className="self-start border border-white/14 bg-[#182321] p-5 sm:p-7">
          ...
          <div className="mt-6 border-b border-white/12 pb-5">
            <div className="flex justify-between gap-4">
              <div><p className="font-semibold">Project review deposit</p><p className="mt-1 text-sm text-white/52">One finished appearance or product placement result</p></div>
